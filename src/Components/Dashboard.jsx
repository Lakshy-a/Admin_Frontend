  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-screen">
      ...
      <div className="w-full lg:w-4/5 flex flex-col">
        ...
        <div className={`p-4 flex-grow ${!darkMode ? 'bg-white text-black' : 'bg-[#1E293B] text-gray-500'}`}>
          <h2 className={`text-xl font-bold mb-4 ${!darkMode ? 'text-black' : 'text-white'}`}>
            Welcome to the Admin Dashboard
          </h2>
          <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 `}>
            <div className={`${!darkMode ? 'bg-white' : 'bg-gray-900 text-white'} p-6 rounded-lg shadow-md`}>
